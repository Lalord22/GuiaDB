...
<body>
  ...
  <div class="container">
    <div class="left-half">
      ...
      <div class="contact">
        <p><span>(+506) 8956-7890</span></p>
        <a href="#"><img src="../images/whatsapp-text-logo.png" alt="WhatsApp logo"></a>
        <a href="info@jegeda.com"><img src="../images/logoCorreo.png" alt="Email logo"></a>
      </div>
      <div class="mission">
        <h2>Misión</h2>
