  ...
  protected void processRequest(HttpServletRequest request, 
    ...
    void updateModel(HttpServletRequest request){
       Model model= (Model) request.getAttribute("model");
        ...
        model.getCurrent().setNumeroPlaca(request.getParameter("numeroFld")); //aun no se como solucionarlo con el id
   }    
    ...
    public String showAction(HttpServletRequest request) {
        ...
        try{
            model.setCurrent(service.polizaFind(model.getCurrent().getId()));
            if(!(model.getCurrent().getCliente().getCedula().equals(usuario.getCedula())))//MODIFIQUE ESTA LINEA
